...
public class ML_PersianDatePicker extends LinearLayout{
    ...
    private final ML_PersianNumberPicker yearNumberPicker;
    private final ML_PersianNumberPicker monthNumberPicker;
    private final ML_PersianNumberPicker dayNumberPicker;
    ...
    public ML_PersianDatePicker(Context context) {
        this(context, null, -1);
    }

    public ML_PersianDatePicker(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public ML_PersianDatePicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        // inflate views
        View view = LayoutInflater.from(context).inflate(R.layout.ml_persian_date_picker, this);
