 ...
 */
public class ML_VideoSlimEncoder {
    ...
    private ML_CodecInputSurface mInputSurface;
     ...
     *
     * */
    public boolean convertVideo(final String sourcePath, String destinationPath, int nwidth, int nheight, int nbitrate, ML_SlimProgressListener listener) {
...
//            }
    ...
    private void prepareEncoder(MediaFormat inputFormat) {
        ...
        mInputSurface = new ML_CodecInputSurface(mEncoder.createInputSurface());
